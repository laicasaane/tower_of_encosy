...
{
    public static ReadOnlySpan<byte> AsBytes<T>(ReadOnlySpan<T> span) => throw null;
    ...
    public static ReadOnlySpan<T> CreateReadOnlySpan<T>(ref T reference, int length) => throw null;

    public static Span<T> CreateSpan<T>(ref T reference, int length) => throw null;
    ...
    public static bool TryGetMemoryManager<T, TManager>(ReadOnlyMemory<T> memory, out TManager manager) where TManager : MemoryManager<T> => throw null;

    public static bool TryGetMemoryManager<T, TManager>(ReadOnlyMemory<T> memory, out TManager manager, out int start, out int length) where TManager : MemoryManager<T> => throw null;
    ...
    public static void Write<T>(Span<byte> destination, ref T value) where T : struct => throw null;
}
