...
{
    [Generator]
    public class GenericVariantGenerator : IIncrementalGenerator
    {
        ...
        public const string IVARIANT_T = $"global::{NAMESPACE}.IVariant<";
        ...
        public static bool IsStructSyntaxMatch(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            return syntaxNode is StructDeclarationSyntax structSyntax
                ...
                && structSyntax.BaseList.Types.Any(
                    static x => x.Type.IsTypeNameGenericCandidate(NAMESPACE, "IVariant", out _)
                );
        }
        ...
        )
        {
            ...
            try
            {
                ...
                var declaration = new GenericVariantDeclaration(candidates, compilation, context.CancellationToken);
        ...
        private static readonly DiagnosticDescriptor s_errorDescriptor
            = new("SG_GENERIC_VARIANTS_01"
                , "Generic Variant Generator Error"
                , "This error indicates a bug in the Generic Variant source generators. Error message: '{0}'."
                , "EncosyTower.Variants.IVariant<T>"
