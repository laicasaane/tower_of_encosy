...
{
    using static EncosyTower.SourceGen.Helpers.Mvvm.SuppressionDescriptors;
    ...
    {
        private const string ATTRIBUTE = "EncosyTower.Mvvm.ComponentModel.ObservablePropertyAttribute";
        ...
        public override void ReportSuppressions(SuppressionAnalysisContext context)
        {
            ...
            foreach (Diagnostic diagnostic in context.ReportedDiagnostics)
            {
                ...
                if (declaredSymbol is IFieldSymbol fieldSymbol
                    ...
                    && fieldSymbol.HasAttributeWithType(attribTypeSymbol, token)
                )
                {
