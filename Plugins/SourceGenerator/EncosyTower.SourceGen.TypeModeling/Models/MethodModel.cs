...
{
    public readonly struct MethodModel : System.IEquatable<MethodModel>
    {
        ...
        public override int GetHashCode()
            => (int)HashValue.Combine(Name, ReturnTypeFullName, Accessibility, RefKind, IsStatic, MethodKind, Parameters, TypeParameters);
