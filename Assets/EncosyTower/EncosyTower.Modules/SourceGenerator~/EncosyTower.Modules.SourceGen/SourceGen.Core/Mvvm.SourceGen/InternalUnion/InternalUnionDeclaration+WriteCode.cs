...
namespace EncosyTower.Modules.Mvvm.InternalUnionSourceGen
{
    ...
    partial class InternalUnionDeclaration
    {
        ...
        private const string GENERATED_CODE = $"[global::System.CodeDom.Compiler.GeneratedCode(\"EncosyTower.Modules.Mvvm.InternalUnionGenerator\", \"{SourceGenVersion.VALUE}\")]";
        ...
        )
        {
            ...
            p.PrintLine($"namespace {NAMESPACE}.__Internal.{assemblyName.ToValidIdentifier()}");
            p.OpenScope();
            {
                p.PrintLine("/// <summary>");
