...
namespace EncosyTower.SourceGen.Generators.DataAuthoring.Databases
{
    using static EncosyTower.SourceGen.Generators.DataAuthoring.Helpers;

    partial class DatabaseDeclaration
    {
        public const string GENERATED_SHEET_ATTRIBUTE = "[global::EncosyTower.Data.Authoring.SourceGen.GeneratedSheet(typeof({0}), typeof({1}), typeof({2}))]";
        ...
        )
        {
            ...
            p.PrintBeginLine()
                ...
                .Print($" : global::EncosyTower.Data.Authoring.SourceGen.IContains<{databaseClassName}.{sheetName}>")
                .PrintEndLine();
            p.OpenScope();
            {
                p.PrintBeginLine()
                    .Print($"[global::EncosyTower.Data.Authoring.SourceGen.SheetNamingAttribute(")
                    .Print($"\"{table.SheetName}\"")
                    .Print($", global::EncosyTower.Data.Authoring.NamingStrategy.{table.NamingStrategy}")
                    .Print(")]")
                    .PrintEndLine();
