...
namespace EncosyTower.SourceGen.Generators.DataAuthoring.Databases
{
    ...
    partial class DataDeclaration
    {
        ...
        )
        {
            ...
            {
                p.PrintLine($"[global::EncosyTower.Data.Authoring.SourceGen.GeneratedSheetRow(typeof({idTypeName}), typeof({typeFullName}))]");
            }
            else
            {
                p.PrintLine($"[global::EncosyTower.Data.Authoring.SourceGen.GeneratedDataRowAttribute(typeof({typeFullName}))]");
            }
