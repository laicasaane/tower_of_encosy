    ...
    partial class DatabaseDeclaration
    {
        ...
        )
        {
            ...
            p.PrintBeginLine()
                ...
                .Print($" : global::EncosyTower.Data.Authoring.SourceGen.IContains<{databaseClassName}.SheetContainer>")
                .PrintEndLine();
            p.OpenScope();
            {
                p.PrintLine("[global::System.Serializable]");
                p.PrintLine("[global::EncosyTower.Data.Authoring.SourceGen.GeneratedSheetContainer]");
                p.PrintLine(GENERATED_CODE).PrintLine(EXCLUDE_COVERAGE);
                p.PrintLine($"public partial class SheetContainer : global::EncosyTower.Data.Authoring.DataSheetContainerBase");
                p.OpenScope();
                {
                    if (containsTables)
                    {
