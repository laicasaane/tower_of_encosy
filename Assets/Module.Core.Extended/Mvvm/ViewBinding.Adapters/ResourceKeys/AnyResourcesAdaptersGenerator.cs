...
namespace Module.Core.Extended.Editor.Mvvm.ViewBinding.Adapters.ResourceKeys
{
    [Generator]
...
");
            ...
            p.PrintLine("namespace Module.Core.Extended.Mvvm.ViewBinding.Adapters.ResourceKeys");
            p.OpenScope();
            {
