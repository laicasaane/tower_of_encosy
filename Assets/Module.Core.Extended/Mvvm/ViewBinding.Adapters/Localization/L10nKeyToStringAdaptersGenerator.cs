#if UNITY_EDITOR && ANNULUS_CODEGEN && UNITY_LOCALIZATION && MODULE_CORE_MVVM_ADAPTERS_GENERATOR

using System;
using Module.Core.CodeGen;
using UnityCodeGen;

namespace Module.Core.Extended.Editor.Mvvm.ViewBinding.Adapters.Localization
{
    [Generator]
...
using System;
using Module.Core.Localization;
using Module.Core.Mvvm.ViewBinding;
using Module.Core.Unions;
");

            p.PrintLine("namespace Module.Core.Extended.Mvvm.ViewBinding.Adapters.Localization");
            p.OpenScope();
            {
