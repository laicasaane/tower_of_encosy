...
namespace Module.Core.UnionIds.SourceGen
{
    ...
    {
        public const string UNION_ID_ATTRIBUTE = "global::Module.Core.UnionIds.UnionIdAttribute";
        public const string UNION_ID_KIND_ATTRIBUTE = "global::Module.Core.UnionIds.KindForUnionIdAttribute";
        private const string SKIP_ATTRIBUTE = "global::Module.Core.UnionIds.SkipSourceGenForAssemblyAttribute";
        ...
        private static bool IsSyntaxMatchId(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            return syntaxNode is StructDeclarationSyntax structSyntax
                && structSyntax.HasAttributeCandidate("Module.Core", "UnionId");
        }
        ...
        private static bool IsSyntaxMatchKind(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            return syntaxNode is BaseTypeDeclarationSyntax typeSyntax
                ...
                && typeSyntax.GetAttribute("Module.Core", "KindForUnionId") is AttributeSyntax attribSyntax
