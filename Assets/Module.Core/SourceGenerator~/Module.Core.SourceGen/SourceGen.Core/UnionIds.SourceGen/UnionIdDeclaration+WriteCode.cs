...
namespace Module.Core.UnionIds.SourceGen
{
    partial class UnionIdDeclaration
    {
        ...
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.UnionIds.SourceGen.UnionIdGenerator\", \"1.0.0\")]";
        ...
        private void WriteSerializable(ref Printer p, string typeName)
        {
            ...
            p.PrintBeginLine("public partial struct Serializable ")
                .Print(": global::Module.Core.ITryConvert<").Print(typeName).Print(">")
