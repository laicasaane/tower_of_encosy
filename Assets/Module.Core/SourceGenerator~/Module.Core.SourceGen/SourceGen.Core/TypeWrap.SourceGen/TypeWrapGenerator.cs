...
namespace Module.Core.TypeWrap.SourceGen
{
    ...
    {
        public const string NAMESPACE = "Module.Core.TypeWrap";
        public const string WRAP_TYPE = "WrapType";
        public const string WRAP_TYPE_ATTRIBUTE = "global::Module.Core.TypeWrap.WrapTypeAttribute";
        public const string WRAP_RECORD = "WrapRecord";
        public const string WRAP_RECORD_ATTRIBUTE = "global::Module.Core.TypeWrap.WrapRecordAttribute";
        public const string GENERATOR_NAME = nameof(TypeWrapGenerator);
        private const string SKIP_ATTRIBUTE = "global::Module.Core.TypeWrap.SkipSourceGenForAssemblyAttribute";
