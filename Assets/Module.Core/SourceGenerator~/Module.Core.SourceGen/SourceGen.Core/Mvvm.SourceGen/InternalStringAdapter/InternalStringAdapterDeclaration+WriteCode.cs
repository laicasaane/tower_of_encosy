...
namespace Module.Core.Mvvm.InternalStringAdapterSourceGen
{
    partial class InternalStringAdapterDeclaration
    {
        private const string AGGRESSIVE_INLINING = "[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]";
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.Mvvm.InternalStringAdapterGenerator\", \"1.0.0\")]";
        private const string EXCLUDE_COVERAGE = "[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]";
        private const string IADAPTER = "global::Module.Core.Mvvm.ViewBinding.IAdapter";
        private const string ADAPTER_ATTRIBUTE = "[global::Module.Core.Mvvm.ViewBinding.Adapter(sourceType: typeof({0}), destType: typeof(string), order: 1)]";
        private const string LABEL_ATTRIBUTE = "[global::Module.Core.Label(\"{0}\", \"{1}\")]";
        ...
        private static string WriteAdapter(ImmutableArray<TypeRef> types, string assemblyName)
        {
            ...
            p.PrintLine($"namespace Module.Core.Mvvm.ViewBinding.__InternalStringAdapters.{assemblyName.ToValidIdentifier()}");
            p.OpenScope();
            {
