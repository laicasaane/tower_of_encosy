...
namespace Module.Core.Mvvm.CodeRefactors
{
    ...
    internal class MvvmDiagnosticAnalyzer : DiagnosticAnalyzer
    {
        ...
        public const string INTERFACE = "Module.Core.Mvvm.ComponentModel.IObservableObject";
        public const string ATTRIBUTE = "global::Module.Core.Mvvm.ComponentModel.ObservablePropertyAttribute";
