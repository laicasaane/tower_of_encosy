...
namespace Module.Core.Mvvm.SourceGen.Binders
{
    partial class BinderDeclaration
    {
        private const string AGGRESSIVE_INLINING = "[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]";
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.Mvvm.SourceGen.Binders.BinderGenerator\", \"1.0.0\")]";
        ...
        private const string GENERATED_BINDING_PROPERTY = "[global::Module.Core.Mvvm.ViewBinding.SourceGen.GeneratedBindingProperty({0}, typeof({1}))]";
        private const string GENERATED_BINDING_COMMAND = "[global::Module.Core.Mvvm.ViewBinding.SourceGen.GeneratedBindingCommand(";
        private const string GENERATED_CONVERTER = "[global::Module.Core.Mvvm.ViewBinding.SourceGen.GeneratedConverter({0}, typeof({1}))]";
        private const string IADAPTER = "global::Module.Core.Mvvm.ViewBinding.IAdapter";
        private const string CACHED_UNION_CONVERTER = "global::Module.Core.Unions.Converters.CachedUnionConverter";
        ...
        public string WriteCode()
        {
            ...
            if (HasBaseBinder)
            {
                p.Print(" : global::Module.Core.Mvvm.ViewBinding.IBinder");
            }
        ...
        private void WriteBindingPropertyMethodInfoAttributes(ref Printer p)
        {
            foreach (var member in BindingPropertyRefs)
            {
                ...
                p.PrintBeginLine()
                    .Print("[global::Module.Core.Mvvm.ViewBinding.SourceGen.BindingPropertyMethodInfo(")
        ...
        private void WriteBindingCommandMethodInfoAttributes(ref Printer p)
        {
            ...
            {
                p.PrintBeginLine()
                    .Print("[global::Module.Core.Mvvm.ViewBinding.SourceGen.BindingCommandMethodInfo(")
        ...
        private void WriteBindingProperties(ref Printer p)
        {
            ...
            foreach (var member in BindingPropertyRefs)
            {
                ...
                p.PrintLine($"private {readonlyKeyword}global::Module.Core.Mvvm.ViewBinding.BindingProperty {BindingPropertyName(member)} =  new global::Module.Core.Mvvm.ViewBinding.BindingProperty();");
                p.PrintEndLine();
            }
        ...
        private void WriteConverters(ref Printer p)
        {
            ...
            foreach (var member in BindingPropertyRefs)
            {
                ...
                p.PrintLine($"private {readonlyKeyword}global::Module.Core.Mvvm.ViewBinding.Converter {ConverterName(member)} = new global::Module.Core.Mvvm.ViewBinding.Converter();");
                p.PrintEndLine();
            }
        ...
        private void WriteBindingCommands(ref Printer p)
        {
            ...
            foreach (var member in BindingCommandRefs)
            {
                ...
                p.PrintLine($"private {readonlyKeyword}global::Module.Core.Mvvm.ViewBinding.BindingCommand {BindingCommandName(member)} =  new global::Module.Core.Mvvm.ViewBinding.BindingCommand();");
                p.PrintEndLine();
            }
        ...
        private void WriteListeners(ref Printer p)
        {
            ...
            foreach (var member in BindingPropertyRefs)
            {
                ...
                p.PrintLine($"/// </summary>");
                p.PrintLine(GENERATED_CODE);
                p.PrintLine($"private readonly global::Module.Core.Mvvm.ComponentModel.PropertyChangeEventListener<{ClassName}> {ListenerName(member)};");
                p.PrintEndLine();
            }
        ...
        private void WriteRelayCommands(ref Printer p)
        {
            ...
            foreach (var member in BindingCommandRefs)
            {
                ...
                if (member.Parameter == null)
                {
                    p.PrintLine($"private global::Module.Core.Mvvm.Input.IRelayCommand {RelayCommandName(member)};");
                }
                else
                {
                    p.PrintLine($"private global::Module.Core.Mvvm.Input.IRelayCommand<{member.Parameter.Type.ToFullName()}> {RelayCommandName(member)};");
                }
        ...
        private void WriteConstructor(ref Printer p)
        {
            ...
            p.OpenScope();
            {
                foreach (var member in BindingPropertyRefs)
                {
                    ...
                    p.PrintLine($"this.{ListenerName(member)} = new global::Module.Core.Mvvm.ComponentModel.PropertyChangeEventListener<{ClassName}>(this)");
                    p.OpenScope();
        ...
        private void WritePartialOnBindFailedMethods(ref Printer p)
        {
            ...
            {
                p.PrintLine("partial void OnBindPropertyFailed(global::Module.Core.Mvvm.ViewBinding.BindingProperty bindingProperty);");
                p.PrintEndLine();
            }

            if (BindingCommandRefs.Length > 0 && HasOnBindCommandFailedMethod == false)
            {
                p.PrintLine("partial void OnBindCommandFailed(global::Module.Core.Mvvm.ViewBinding.BindingCommand bindingCommand);");
                p.PrintEndLine();
            }
        }
        ...
        private void WriteUnionOverloads(ref Printer p)
        {
            ...
            foreach (var member in BindingPropertyRefs)
            {
                ...
                p.PrintLine($"/// from <see cref=\"global::Module.Core.Unions.Union\"/>");
                ...
                p.PrintLine($"private void {methodName}(in global::Module.Core.Unions.Union union)");
                p.OpenScope();
                {
