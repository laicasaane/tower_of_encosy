...
namespace Module.Core.Mvvm.ObservablePropertySourceGen
{
    partial class ObservablePropertyDeclaration
    {
        ...
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.Mvvm.ObservablePropertyGenerator\", \"1.2.0\")]";
        private const string EXCLUDE_COVERAGE = "[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]";
        private const string GENERATED_OBSERVABLE_PROPERTY = "[global::Module.Core.Mvvm.ComponentModel.SourceGen.GeneratedObservableProperty]";
        private const string GENERATED_PROPERTY_CHANGING_HANDLER = "[global::Module.Core.Mvvm.ComponentModel.SourceGen.GeneratedPropertyChangingEventHandler]";
        private const string GENERATED_PROPERTY_CHANGED_HANDLER = "[global::Module.Core.Mvvm.ComponentModel.SourceGen.GeneratedPropertyChangedEventHandler]";
        private const string GENERATED_PROPERTY_NAME_CONSTANT = "[global::Module.Core.Mvvm.ComponentModel.SourceGen.GeneratedPropertyNameConstant]";
        private const string IS_OBSERVABLE_OBJECT = "[global::Module.Core.Mvvm.ComponentModel.SourceGen.IsObservableObject(typeof({0}))]";
        private const string UNION = "global::Module.Core.Unions.Union";
        private const string CACHED_UNION_CONVERTER = "global::Module.Core.Unions.Converters.CachedUnionConverter";
        private const string INOTIFY_PROPERTY_CHANGING_INTERFACE = "global::Module.Core.Mvvm.ComponentModel.INotifyPropertyChanging";
        private const string INOTIFY_PROPERTY_CHANGED_INTERFACE = "global::Module.Core.Mvvm.ComponentModel.INotifyPropertyChanged";
        private const string PROPERTY_CHANGE_EVENT_LISTENER = "global::Module.Core.Mvvm.ComponentModel.PropertyChangeEventListener";
        private const string PROPERTY_CHANGE_EVENT_ARGS = "global::Module.Core.Mvvm.ComponentModel.PropertyChangeEventArgs";
        ...
        private void WriteEvents(ref Printer p)
        {
            foreach (var member in FieldRefs)
            {
                ...
                p.PrintLine($"private event global::Module.Core.Mvvm.ComponentModel.PropertyChangingEventHandler {OnChangingEventName(member)};");
                p.PrintEndLine();

                p.PrintLine(GENERATED_CODE).PrintLine(GENERATED_PROPERTY_CHANGED_HANDLER);
                p.PrintLine($"private event global::Module.Core.Mvvm.ComponentModel.PropertyChangedEventHandler {OnChangedEventName(member)};");
                p.PrintEndLine();
            }
            ...
            {
                p.PrintLine(GENERATED_CODE).PrintLine(GENERATED_PROPERTY_CHANGED_HANDLER);
                p.PrintLine($"private event global::Module.Core.Mvvm.ComponentModel.PropertyChangedEventHandler {OnChangedEventName(property)};");
                p.PrintEndLine();
            }
        }
        ...
        {
            const string ATTRIBUTE = "[global::Module.Core.Mvvm.ComponentModel.SourceGen.NotifyPropertyChangingInfo(\"{0}\", typeof({1}))]";
        ...
        {
            const string ATTRIBUTE = "[global::Module.Core.Mvvm.ComponentModel.SourceGen.NotifyPropertyChangedInfo(\"{0}\", typeof({1}))]";
