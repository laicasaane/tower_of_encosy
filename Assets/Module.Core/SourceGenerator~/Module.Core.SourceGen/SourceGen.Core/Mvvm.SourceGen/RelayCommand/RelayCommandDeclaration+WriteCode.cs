...
namespace Module.Core.Mvvm.RelayCommandSourceGen
{
    ...
    {
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.Mvvm.RelayCommandGenerator\", \"1.0.0\")]";
        private const string EXCLUDE_COVERAGE = "[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]";
        private const string GENERATED_RELAY_COMMAND = "[global::Module.Core.Mvvm.Input.SourceGen.GeneratedRelayCommand({0})]";
        ...
        public string WriteCode()
        {
            ...
            p.PrintBeginLine("partial class ").Print(ClassName)
                .PrintEndLine(" : global::Module.Core.Mvvm.Input.ICommandListener");
        ...
        private void WriteRelayCommandInfoAttributes(ref Printer p)
        {
            foreach (var member in MemberRefs)
            {
                ...
                p.PrintBeginLine()
                    .Print($"[global::Module.Core.Mvvm.Input.RelayCommandInfo(\"{propName}\", ");
        ...
        private void WriteTryGetCommand(ref Printer p)
        {
            ...
            p.PrintLine("public bool TryGetCommand<TCommand>(string commandName, out TCommand command) where TCommand : global::Module.Core.Mvvm.Input.ICommand");
            p.OpenScope();
            {
        ...
        private static string CommandTypeName(MemberRef method)
        {
            ...
            {
                return "global::Module.Core.Mvvm.Input.RelayCommand";
            }

            var param = method.Member.Parameters[0];
            return $"global::Module.Core.Mvvm.Input.RelayCommand<{param.Type.ToFullName()}>";
        }
        ...
        private static string CommandInterfaceName(MemberRef method)
        {
            if (method.Member.Parameters.Length < 1)
            {
                return "global::Module.Core.Mvvm.Input.IRelayCommand";
            }

            var param = method.Member.Parameters[0];
            return $"global::Module.Core.Mvvm.Input.IRelayCommand<{param.Type.ToFullName()}>";
        }
