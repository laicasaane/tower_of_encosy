...
namespace Module.Core.Mvvm.InternalUnionSourceGen
{
    partial class InternalUnionDeclaration
    {
        ...
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.Mvvm.InternalUnionGenerator\", \"1.0.0\")]";
        ...
        public const string GENERATED_INTERNAL_UNIONS = "[global::Module.Core.Unions.SourceGen.GeneratedInternalUnions]";
        ...
        )
        {
            ...
            p.PrintLine($"namespace Module.Core.Unions.__Internal.{assemblyName.ToValidIdentifier()}");
            p.OpenScope();
            {
                p.PrintLine("/// <summary>");
