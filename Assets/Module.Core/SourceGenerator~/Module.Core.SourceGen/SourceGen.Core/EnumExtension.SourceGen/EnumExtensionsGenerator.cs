...
namespace Module.Core.EnumExtensions.SourceGen
{
    ...
    {
        public const string ENUM_EXTENSIONS_ATTRIBUTE = "global::Module.Core.EnumExtensions.EnumExtensionsAttribute";
        ...
        private static bool IsValidEnumSyntax(SyntaxNode node, CancellationToken _)
        {
            return node is EnumDeclarationSyntax syntax
                ...
                && syntax.HasAttributeCandidate("Module.Core.EnumExtensions", "EnumExtensions")
                ;
        }
        ...
        private static readonly DiagnosticDescriptor s_errorDescriptor
            = new("SG_ENUM_EXTENSIONS_01"
                ...
                , "Module.Core.EnumExtensions.EnumExtensionsAttribute"
