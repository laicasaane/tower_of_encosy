...
namespace Module.Core.EnumExtensions.SourceGen
{
    ...
    {
        public const string ENUM_EXTENSIONS_FOR_ATTRIBUTE = "global::Module.Core.EnumExtensions.EnumExtensionsForAttribute";
        ...
        private static bool IsValidClassSyntax(SyntaxNode node, CancellationToken _)
        {
            return node is ClassDeclarationSyntax syntax
                ...
                && syntax.HasAttributeCandidate("Module.Core.EnumExtensions", "EnumExtensionsFor")
                ;
        }
        ...
        )
        {
            ...
            foreach (var attribList in syntax.AttributeLists)
            {
                ...
                {
                    if (attrib.Name.IsTypeNameCandidate("Module.Core.EnumExtensions", "EnumExtensionsFor") == false
        ...
        private static readonly DiagnosticDescriptor s_errorDescriptor
            = new("SG_ENUM_EXTENSIONS_02"
                ...
                , "Module.Core.EnumExtensions.EnumExtensionsForAttribute"
