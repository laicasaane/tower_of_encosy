...
namespace Module.Core.EnumExtensions.SourceGen
{
    partial class EnumExtensionsDeclaration
    {
        ...
        private const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.EnumExtensions.SourceGen.EnumExtensionsGenerator\", \"1.0.0\")]";
        ...
        private void WriteInterface(ref Printer p)
        {
            ...
            p = p.IncreasedIndent();
            {
                p.PrintBeginLine(": global::Module.Core.EnumExtensions.IEnumExtensions<")
                    .Print(FullyQualifiedName).Print(", ").Print(UnderlyingTypeName)
                    .PrintEndLine(">");

                if (ReferenceUnityCollections)
                {
                    p.PrintBeginLine(", global::Module.Core.IToFixedString<").Print(FixedStringTypeFullyQualifiedName).PrintEndLine(">");
                    p.PrintBeginLine(", global::Module.Core.IToDisplayFixedString<").Print(FixedStringTypeFullyQualifiedName).PrintEndLine(">");
                }
            }
            p = p.DecreasedIndent();
            p.OpenScope();
        ...
        private void WriteAttribute(ref Printer p)
        {
            ...
            p.PrintBeginLine("[global::Module.Core.EnumExtensions.SourceGen.GeneratedEnumExtensionsFor(typeof(")
