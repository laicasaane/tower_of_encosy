...
namespace Module.Core.Entities.SourceGen
{
    ...
    {
        protected override string Interface => "global::Module.Core.Entities.IBufferLookups";
        ...
        protected override DiagnosticDescriptor ErrorDescriptor
            => new("SG_BUFFER_LOOKUPS_01"
                ...
                , "Module.Core.Entities.IBufferLookups"
    ...
    internal sealed class BufferLookupDeclaration : LookupDeclaration
    {
        ...
        public override string InterfaceLookupRO => "global::Module.Core.Entities.Lookups.IBufferLookupRO";

        public override string InterfaceLookupRW => "global::Module.Core.Entities.Lookups.IBufferLookupRW";
