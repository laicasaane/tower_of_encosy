...
namespace Module.Core.Entities.SourceGen
{
    ...
    {
        protected override string Interface => "global::Module.Core.Entities.IPhysicsBufferLookups";
        ...
        protected override DiagnosticDescriptor ErrorDescriptor
            => new("SG_PHYSICS_BUFFER_LOOKUPS_01"
                ...
                , "Module.Core.Entities.IPhysicsBufferLookups"
    ...
    internal sealed class PhysicsBufferLookupDeclaration : LookupDeclaration
    {
        ...
        public override string InterfaceLookupRO => "global::Module.Core.Entities.Lookups.IPhysicsBufferLookupRO";

        public override string InterfaceLookupRW => "global::Module.Core.Entities.Lookups.IPhysicsBufferLookupRW";
