...
namespace Module.Core.Entities.SourceGen
{
    ...
    {
        private const string SKIP_ATTRIBUTE = "global::Module.Core.Entities.SkipSourceGenForAssemblyAttribute";
        ...
        private static bool IsStructSyntaxMatch(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            return syntaxNode is StructDeclarationSyntax structSyntax
                ...
                && structSyntax.HasAttributeCandidate("Module.Core.Entities", "Lookup");
        }
