...
namespace Module.Core.Entities.SourceGen
{
    ...
    {
        protected override string Interface => "global::Module.Core.Entities.IPhysicsComponentLookups";
        ...
        protected override DiagnosticDescriptor ErrorDescriptor
            => new("SG_PHYSICS_COMPONENT_LOOKUPS_01"
                ...
                , "Module.Core.Entities.IPhysicsComponentLookups"
    ...
    internal sealed class PhysicsComponentLookupDeclaration : LookupDeclaration
    {
        ...
        public override string InterfaceLookupRO => "global::Module.Core.Entities.Lookups.IPhysicsComponentLookupRO";

        public override string InterfaceLookupRW => "global::Module.Core.Entities.Lookups.IPhysicsComponentLookupRW";
