...
namespace Module.Core.Entities.SourceGen
{
    internal abstract class LookupCodeWriter
    {
        ...
        protected const string GENERATED_CODE = "[global::System.CodeDom.Compiler.GeneratedCode(\"Module.Core.Entities.SourceGen.LookupGenerator\", \"1.0.0\")]";
        ...
        protected const string BOOL = "global::Module.Core.Bool<";
        ...
        public string Write(LookupDeclaration declaration)
        {
            ...
            p.PrintBeginLine("partial struct ")
                ...
                .Print(" : Module.Core.Entities.Lookups.ILookups")
                .PrintEndLine();
