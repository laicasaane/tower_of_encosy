...
namespace Module.Core.EnumTemplates.SourceGen
{
    ...
    {
        public const string ENUM_TEMPLATE_ATTRIBUTE = "global::Module.Core.EnumExtensions.EnumTemplateAttribute";
        public const string ENUM_MEMBERS_FOR_TEMPLATE_ATTRIBUTE = "global::Module.Core.EnumExtensions.EnumMembersForTemplateAttribute";
        public const string TYPE_MEMBER_FOR_ENUM_TEMPLATE_ATTRIBUTE = "global::Module.Core.EnumExtensions.TypeNameMemberForEnumTemplateAttribute";
        private const string SKIP_ATTRIBUTE = "global::Module.Core.EnumExtensions.SkipSourceGenForAssemblyAttribute";
        ...
        private static bool IsSyntaxMatchTemplate(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            return syntaxNode is StructDeclarationSyntax structSyntax
                && structSyntax.HasAttributeCandidate("Module.Core.EnumExtensions", "EnumTemplate");
        }
        ...
        private static bool IsSyntaxMatchKind(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            var attribSyntax = baseTypeSyntax.GetAttribute("Module.Core.EnumExtensions", "EnumMembersForTemplate");
            attribSyntax ??= baseTypeSyntax.GetAttribute("Module.Core.EnumExtensions", "TypeNameMemberForEnumTemplate");
        ...
        private static readonly DiagnosticDescriptor s_errorDescriptor
            = new("SG_ENUM_TEMPLATE_01"
                ...
                , "Module.Core.EnumTemplateAttribute"
