...
namespace Module.Core.UserDataStores.SourceGen
{
    ...
    internal class UserDataAccessProviderGenerator : IIncrementalGenerator
    {
        ...
        private const string ATTRIBUTE = "global::Module.Core.UserDataStores.UserDataAccessProviderAttribute";
        private const string IUSER_DATA_ACCESS = "global::Module.Core.UserDataStores.IUserDataAccess";
        private const string SKIP_ATTRIBUTE = "global::Module.Core.UserDataStores.SkipSourceGenForAssemblyAttribute";
        ...
        private static bool IsSyntaxMatchProviderClass(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            return syntaxNode is ClassDeclarationSyntax syntax
                && syntax.HasAttributeCandidate("Module.Core.UserDataStores", "UserDataAccessProvider");
        }
        ...
        public static bool IsSyntaxMatchDataAccessClass(SyntaxNode syntaxNode, CancellationToken token)
        {
            ...
            return syntaxNode is ClassDeclarationSyntax syntax
                ...
                && syntax.BaseList.Types.Any(
                    static x => x.Type.IsTypeNameCandidate("Module.Core.UserDataStores", "IUserDataAccess"
                ));
        }
        ...
        private static readonly DiagnosticDescriptor s_errorDescriptor
            = new("SG_USER_DATA_ACCESS_PROVIDER_01"
                ...
                , "Module.Core.UserDataStores.UserDataAccessProviderAttribute"
