...
{
    public class SerializedGuidTests
    {
        [Test]
        public void SerializedGuid_Test_Implicit_Operator()
        {
            var guid = new Guid("b23b48fcb15d994c939451ce1a44b3fd");
            SerializedGuid serializedGuid = guid;
            Assert.IsTrue(serializedGuid == guid);
        }

#if UNITY_COLLECTIONS
        [Test]
        public void SerializedGuid_Test_Conversion_D()
        {
            const string STR = "b23b48fc-b15d-994c-9394-51ce1a44b3fd";

            var guid = new Guid(STR);
            var serializedGuid = new SerializedGuid(STR);
            Assert.IsTrue(serializedGuid == guid);
        }

        [Test]
        public void SerializedGuid_Test_Conversion_N()
        {
        ...
        [Test]
        public void SerializedGuid_Test_Conversion_B()
        {
            const string STR = "{b23b48fc-b15d-994c-9394-51ce1a44b3fd}";
        ...
        [Test]
        public void SerializedGuid_Test_Conversion_X()
        {
