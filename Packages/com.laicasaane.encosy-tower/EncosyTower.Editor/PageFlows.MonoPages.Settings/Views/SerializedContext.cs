...
namespace EncosyTower.Editor.PageFlows.MonoPages.Settings.Views
{
    internal class SerializedContext
    {
        ...
        public SerializedProperty GetWarnNoSubscriber()
            => Object.FindProperty(nameof(MonoPageFlowSettings.warnNoSubscriber));
        ...
        public SerializedProperty GetPoolRentingStrategyProperty()
            => Object.FindProperty(nameof(MonoPageFlowSettings.poolRentingStrategy));

        public SerializedProperty GetPoolReturningStrategyProperty()
            => Object.FindProperty(nameof(MonoPageFlowSettings.poolReturningStrategy));
