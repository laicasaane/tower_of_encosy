...
namespace System
{
    ...
    public interface ISpanFormattable : IFormattable
    {
        ...
        /// implementation of <see cref="IFormattable.ToString(string?, IFormatProvider?)"/> on the same type.
        /// TryFormat should return false only if there is not enough space in the destination buffer.
        /// Any other failures should throw an exception.
        /// </remarks>
        bool TryFormat(
